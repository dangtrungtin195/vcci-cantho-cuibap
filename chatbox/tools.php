...
<title>VnSoft4you.com Bot Chatbox Tools</title>
</head>
...
<div align="center"><b>
	<a href="?do=home">Trang chủ</a> |<a href="http://www.vnsoft4you.com">VnSoft4You</a> | <a href="?do=showsmilies">Tất cả smilie</a> | <a href="?do=formadd">Thêm smilie</a> | <a href="?do=banmanage">Thành viên cấm chat</a> | <a href="?do=notice">Thông báo</a> | <a href="?do=badword">Từ cấm</a></b>
</div>
<div align="center">
...
if ($_REQUEST['do'] == 'home')
{
	echo "<center>";
	echo "<br /><br />";
	echo "<b>VnSoft4you.com Bot Chatbox Tools ver 1.0</b><br />";
	echo "VnSoft4you</center>";
}
